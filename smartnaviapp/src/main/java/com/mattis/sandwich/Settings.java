    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBarTimer.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                try {
                    //com.mattis.sandwich.GoogleMap.listHandler.sendEmptyMessageDelayed(6, 3000);
                } catch (Exception e) {
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (buttonView.getId() == R.id.checkBoxGPS) {
            ...
            if (isChecked == false) {
                ...
                //com.mattis.sandwich.GoogleMap.listHandler.sendEmptyMessage(7);
            } else {
                // start Autocorrect anwerfern after 3sek
                // because then activity_settings are surely updated
                //com.mattis.sandwich.GoogleMap.listHandler.sendEmptyMessageDelayed(6, 2000);
            }
            key = "autocorrect";
