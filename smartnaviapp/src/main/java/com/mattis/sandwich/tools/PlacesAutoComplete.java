...
//import com.mattis.sandwich.com.mattis.sandwich.GoogleMap;
...
public class PlacesAutoComplete extends AsyncTask<String, String, StringBuilder> {
    ...
    protected void onPostExecute(StringBuilder jsonResults) {
        try {
            ...
            try {
                /*com.mattis.sandwich.GoogleMap.cursor = cursor;
                com.mattis.sandwich.GoogleMap.changeSuggestionAdapter.sendEmptyMessage(0);*/
            } catch (Exception e) {
                e.printStackTrace();
            }
