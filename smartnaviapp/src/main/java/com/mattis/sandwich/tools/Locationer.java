...
import com.mattis.sandwich.BackgroundService;
import com.mattis.sandwich.BuildConfig;
import com.mattis.sandwich.Map;
...
public class Locationer implements LocationListener {
    ...
    private LocationListener gpsAutocorrectLocationListener = new LocationListener() {
        public void onLocationChanged(Location location) {
            Log.d("LocationListener", "onLocationChanged" + location.toString());
    ...
    public void onConnected(Bundle arg0) {
        ...
        try {
            Location lastLocation = LocationManager.FusedLocationApi.getLastLocation(mGoogleApiClient);
    ...
    public void onProviderDisabled(String provider) {
        ...
        if (settings.getBoolean("gpsDialogShown", false) == false) {
            new writeSettings("gpsDialogShown", true).doInBackground();
            locationListener.onLocationUpdate(5);
        }
    }
    ...
    public void stopAutocorrect() {
        try {
            ...
            if (com.mattis.sandwich.Map.backgroundServiceShallBeOnAgain == true) {
